    ...
    myMarkers.forEach((element, index, array) => {
      ...
      if (element.group == currentGroup) {
        ...
        var popup = L.popup({
          ...
          .setContent('<div class = "modal-content"><h4>'+element.popupHead+'</h4><button class="close-button" aria-label="Close" rel="prev"><span aria-hidden="true">X</span></button><div class = "popUpText">'+popupBodyText+'</div><div class="popUpImage">'+popupBodyImage+'</div><div class="popUpButton">'+popupButton+'</div></div>');
